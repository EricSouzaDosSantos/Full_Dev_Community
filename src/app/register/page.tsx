        ...
        <Card className="w-full max-w-md mx-auto">
          ...
          <CardContent className="space-y-4">
            <div className="space-y-2 w-full">
              ...
              <Input id="email" type="email" placeholder="Digite um email" className="w-full" />
            </div>
            <div className="space-y-2 w-full">
              <Label htmlFor="password">Senha</Label>
              <Input id="password" type="password" placeholder="Digite uma senha" className="w-full" />
            </div>
            <div className="space-y-2 w-full">
              <Label htmlFor="confirm-password">Confirme a senha</Label>
              <Input id="confirm-password" type="password" placeholder="Confirme a sua senha" className="w-full" />
            </div>
