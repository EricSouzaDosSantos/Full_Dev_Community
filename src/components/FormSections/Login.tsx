    ...
    return (
        <section className="grid lg:grid-cols-2 ">
            ...
            <div className="flex flex-col justify-center items-center mt-24 lg:mt-0">
                <h1 className="text-center text-2xl lg:text-4xl font-bold text-white">Bem vindo de volta</h1>
                <p className="text-gray-300 text-center lg:text-xl mt-2">Entre para começar a criar seus formulários.</p>
                <div>
                <Form />
                </div>
